<?php
    ...
    if (!empty($_GET['searchValue'])) {
	    $input = $_GET['searchValue'];

	    $response = selectSearch('books', "book_title", $input);
...
<?php 
    if (isset($not_found)) { ?>
        ...
        <div>
            <h5 style="color: red; font-size: 25px; font-family: ubuntu; width: 100%;">No book related to:  <?= $input; ?></h5>
        </div>
