...
<div class="text animate reveal">
    ...
    <div class="about">
        <img class="author-image animate reveal" src="assets/images/madueke/madueke3.jpg">
        <div class="content">
...
<section id="editorial-reviews">
    ...
    <!-- <div class="cta animate reveal"><a href="#boxset-cta" class="button">Get book now!</a></div> -->
</section>

<section id="sticky-cta">
    <h3 class="">Get this Life-Changing Bookset today!</h3>
    <a href="#boxset-cta" class="button">Get book now!</a>
</section>
